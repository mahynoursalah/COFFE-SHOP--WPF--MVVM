...
{
    // دي الواجهة (Interface) اللي بتحدد الدالة اللي لازم تكون موجودة
    ...
    public class CustomerDataProvider : ICustomerDataProvider
    {
        ...
        {
            // بنعمل تأخير وهمي لمدة 100 ملي ثانية عشان نقلد شكل السيرفر الحقيقي
            await Task.Delay(100);

            // بنرجع لستة العملاء جاهزة ومكتوبة بإيدنا (Hardcoded)
